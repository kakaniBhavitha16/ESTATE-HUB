...
export default function SignUp() {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-indigo-50 via-slate-100 to-blue-100 flex items-center justify-center p-4 sm:p-6 lg:p-8'>
      <div className='w-full max-w-md sm:max-w-lg lg:max-w-xl xl:max-w-2xl mx-auto'>
        <div className='bg-white/90 backdrop-blur-lg rounded-2xl sm:rounded-3xl shadow-xl border border-white/30 overflow-hidden'>
          <div className='px-6 sm:px-8 pt-8 pb-6 text-center bg-gradient-to-b from-white/50 to-transparent'>
            ...
            <p className='text-sm sm:text-base text-slate-500'>Join us to explore the best real estate deals</p>
          </div>

          <div className='px-6 sm:px-8 pb-8'>
            <form onSubmit={handleSubmit} className='space-y-6'>
              <div className='space-y-2'>
                <label htmlFor='username' className='text-sm font-semibold text-slate-700 block ml-1'>
                  Username
                </label>
                <input
                  type='text'
